...
function initOrder(g, oldGraph, oldNodes, oldLayering) {
  ...
  function compareOldOrder(a, b) {
    ...
    //TODO: changes nothing here since initialOrder is overwritten later
    // try to overwrite the final order by sorting it like this
    // ALSO: don't compare rank === rank. just look at the part of the link immediately after the source node, rest will align naturally
