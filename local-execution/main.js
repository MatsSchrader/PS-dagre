...
let corePath = ["Start", "Auftragserstellung", "VK-Lieferung", "VK-Rechnung", "Zahlungseingang",  "End"];
...
dagre.layout(g1to2, {corePath: corePath});
//visualizeGraph(g1to2, false);
//
let g1to3 = initGraph(v.variant1to3);
dagre.layout(g1to3, {corePath: corePath});
//visualizeGraph(g1to3, false);
// //
let g1to4 = initGraph(v.variant1to4);
dagre.layout(g1to4, {corePath: corePath});
//visualizeGraph(g1to4, false);
// //
let g1to7 = initGraph(v.variant1to7);
dagre.layout(g1to7, {corePath: corePath}); //uses last layout as oldGraph
